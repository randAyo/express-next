import {detail} from '../interfaces/index'
const carte = {
  minPrice: 249,
  values: {
    Taille: [
...
const flyer = {
  ...
  values: {
    ...
    Papier: [
      { name: '', value: '' },
      { name: '135g Brilant', value: '135g Brilant' },
...
const poster = {
  ...
  values: {
    ...
    Support: [
      { name: '', value: '' },
      { name: 'Aliminium', value: 'Aliminium' }
    ]
  }
}
const entete = {
...
const details: detail[] = [
  ...
  },
  {
    ...
    content: {
      description: [
        ` Element indispensable de votre communication personnelle ou professionnelle , votre carte de visite reflète votre personnalité ou l’image de votre entreprise.`,
        `Nous offrons un large éventail de possibilités pour produire une carte de visite à votre image : Carton jusqu’à 400g/m2, vernis UV, pelliculage mat, brillant ou soft touch (effet “peau de pêche”)`,
        `Le format 85×55 mm ne se limite pas à la simple carte de visite. Adoptez ce format pour tous vos besoins tels que l’impression de cartes
  de rendez-vous, cartes de fidélité ou tout autre élément de communication / marketing de votre activité professionnelle.`,
        `L’impression offset n’est pas recommandée pour les tirages inférieurs à 1’000 cartes de visite, optez plutôt pour l’impression numérique.
  ...
  },
  {
    ...
    content: {
      description: [
        `Vous devez imprimer plus d’une centaine de fois le même document A4 ? Papier à lettre, affichette, notice d’utilisation, courrier commercial, documentation interne ? La procédé d’impression offset est particulièrement recommandé pour allier qualité
  d’impression et maîtrise des coûts de production.`,
        `Nous imprimons vos documents en noir ou couleurs quadri, en recto ou recto/verso sur du papier offset jusqu’à 120g/m².`,
        `Pour des impressions à but marketing ou d’autres dimensions que le A4 nous vous recommandons de découvrir nos offres d’impression de  flyers et dépliants .`,
        `Pour vous permettre de comparer, nous tenons à votre disposition des échantillons d’impression dans chacune de nos filiales.`
  ...
  },
  {
    ...
    content: {
      description: [
        `Vecteur de communication de main à main par excellence, le flyer est le moyen idéal pour annoncer un événement, promouvoir un service, mettre en lumière une activité.`,
        `Vos flyers véhiculent l’image de votre entreprise ou association, il est donc essentiel d’obtenir un résultat conforme à vos attentes.`,
        `Nous vous proposons une qualité d’impression premium tout en offrant un niveau de prix extrêmement attractif.`
      ],
      accordion: [
        {
          title: 'Dans quels délais mes impressions seront-elles disponibles ?',
  ...
  },
  {
    ...
    content: {
      description: [
        `Les dépliants sont le moyen idéal pour présenter les services de votre entreprise, le menu de votre restaurant, les tarifs de vos prestations, vos offres de voyages ou de croisières etc.`,
        `<b>Classiques dépliants </b>3 volets au format DL ou dépliants originaux carrés, nous proposons un vaste choix de formats et de finitions qui sauront s’adapter à vos exigences.`
      ],
      accordion: [
        {
  ...
  },
  {
    ...
    content: {
      description: [
        `Prises de notes, prises de commande, objets publicitaires … Imprimez vos bloc-notes à l’image de votre entreprise, c’est le support idéal pour véhiculer votre image par le biais d’un objet utile. Nos tarifs sont particulièrement avantageux : Imprimez par exemple 100 bloc-notes A4 pour seulement CHF 4.54 / pièce TTC !`,
        `Les bloc-notes sont également indispensables en restauration. Pour la prise de vos commandes, vos 100 bloc-notes 105 x 210 mm ne vous coûteront que&nbsp;CHF 2.41 / pièce TTC !`
      ],
      accordion: [
        {
  ...
  },
  {
    ...
    content: {
      description: [
        `Conçu pour signaler efficacement votre activité, le roll-up est le support idéal pour toutes les manifestations, foires ou expositions. C’est aussi un allié publicitaire efficace pour un point de vente ou un restaurant si vous souhaitez attirer l’attention
  sur un élément particulier.`,
        `Facile à transporter et à monter, le roll-up vous accompagne partout.`,
        `Nous proposons divers formats adaptés à un usage en intérieur ou en extérieur.`,
        `Tous nos Roll-ups sont livrés prêts à être utilisés. L’étui de transport est inclus dans le prix de chaque modèle.`
      ],
      accordion: [
        {
          title: 'Modèle Classique',
  ...
  },
  {
    ...
    content: {
      description: [
        `Exposition, séminaire, stand, affichage sur le lieu de vente ou toutes formes d’affichage commercial … L’affiche est un puissant vecteur de communication aux multiples déclinaisons.`,
        `Nous imprimons vos affiches sur de nombreux formats, du A3 au A0.`,
        `Le procédé d’impression offset est recommandé pour tous les tirages supérieurs à 10 affiches. Pour des petits tirages ( moins de 10 affiches ), privilégiez l’impression numérique`,
        `Il s’agit de la solution idéale pour allier rendu professionnel et maîtrise des coûts.`,
        `Pour vous permettre de comparer, nous tenons à votre disposition des échantillons d’impression dans chacune de nos filiales.`,
      ],
      accordion: [
        {
